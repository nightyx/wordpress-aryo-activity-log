...
class AAL_Hook_BuddyPress extends AAL_Hook_Base {
    ...
    public function __construct(){
        ...
        add_action('groups_leave_group', array( &$this, 'hooks_aal_bp_leave_group'), 5, 2);

        add_action('groups_group_create_complete', array( &$this, 'hooks_aal_bp_group_created'), 5, 2);
